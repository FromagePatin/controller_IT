...
L'état du signal doit être maintenu au minimum pendant un cyle d'horloge pour qu'il soit valide. %TODO valider si cette information n'est pas trop contraignante pour la conception du controlleur d'IT.
\begin{figure}[H]
	\centering
